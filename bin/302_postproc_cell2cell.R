...
parser <- setup_default_argparser(
    ...
    default_output_dir = "output/302_postproc_cell2cell",
...
scrnaseq.cellcomm::format_cell2cell_wrapper(
    input_interactions_scores = params$input_interactions_scores,
    input_interactions_pval = params$input_interactions_pval,
