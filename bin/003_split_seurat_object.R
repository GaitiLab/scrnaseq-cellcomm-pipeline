...
parser <- setup_default_argparser(
    description = "Split Seurat object into individual samples",
    default_output_dir = "output/000_data/split_by_Sample",
...
if (interactive()) {
    ...
    params$input_file <- "/Users/joankant/Documents/Coding/gaitilab-scrnaseqcellcomm/work/6b/ea8d79c574f5be728bfc08857c61db/example_data_reduced_size.rds"
}
